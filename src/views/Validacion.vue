<template>
  <div>
    ...
    <form @submit.prevent="submit">
      <h4>Email</h4>
      <input type="email" placeholder="Ingresa un email" class="form-control my-3" v-model.lazy="$v.email.$model" :class="{'is-invalid' : $v.email.$error}">
      ...
      <h4>Contraseña</h4>
      <input type="password" placeholder="Ingresa contraseña" class="form-control my-3" v-model.lazy="$v.password.$model" :class="{'is-invalid' : $v.password.$error}">
